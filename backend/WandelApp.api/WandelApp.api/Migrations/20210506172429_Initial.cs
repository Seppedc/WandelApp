        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPointsToEarn = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatPassword = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                    ...
                    CountPetsCaptured = table.Column<int>(type: "int", nullable: false),
                    NextLevelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrentLevelName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_Levels_NextLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountPlayed = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
